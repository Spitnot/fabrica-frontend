...
export default function SetPasswordPage() {
  ...
  const inputCls = "w-full bg-gray-50 border border-gray-200 rounded-lg px-3 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:border-[#D93A35] outline-none transition-colors";
      ...
      <div className="flex-1 flex items-center justify-center bg-white p-8">
        <div className="w-full max-w-[360px]">
          ...
          <h2 className="text-2xl font-black tracking-wide text-gray-900 mb-1"
              style={{ fontFamily: 'var(--font-alexandria)' }}>Create password</h2>
          <p className="text-sm text-gray-400 mb-8">Set a password to activate your account.</p>
