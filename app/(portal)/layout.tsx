...
// ─── Logo compacto (wave icon) ───────────────────────────────────────────────
const FRLogoSVG = ({ width = 120 }: { width?: number }) => (
...
const NAV = [
  ...
  },
  {
    ...
    icon: (active: boolean) => (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={active ? 2.5 : 2}>
        <circle cx="12" cy="12" r="9"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><circle cx="12" cy="17" r="0.5" fill="currentColor"/>
      </svg>
    ),
  },
];
      ...
      <div style={{ display: 'flex', minHeight: '100vh', background: '#fff' }}>
        ...
        <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column' }}>
          <div className="fr-portal-bottomnav" style={{
            ...
            <Link href="/portal"><FRLogoSVG width={80} /></Link>
